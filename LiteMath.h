...
namespace LiteMath 
{
  ...
  struct float4x4
  {
    ...
    float4x4(const glm::mat4 arr)
    {
      row[0] = float4(arr[0][0], arr[0][1], arr[0][2], arr[0][3]);
      row[1] = float4(arr[1][0], arr[1][1], arr[1][2], arr[1][3]);
      row[2] = float4(arr[2][0], arr[2][1], arr[2][2], arr[2][3]);
      row[3] = float4(arr[3][0], arr[3][1], arr[3][2], arr[3][3]);
    }
